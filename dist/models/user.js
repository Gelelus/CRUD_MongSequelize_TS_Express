...
User.prototype.generateAuthToken = function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            user = this;
            token = jsonwebtoken_1.default.sign({ id: user.id.toString() }, 'expressapp');
            return [2, token];
        });
    });
};
User.findByCredentials = function (login, password) { return __awaiter(void 0, void 0, void 0, function () {
    var user, isMatch;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, User.findOne({ where: { name: login } })];
            case 1:
                user = _a.sent();
                if (!user) {
